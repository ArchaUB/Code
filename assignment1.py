...
First you have to ask the customer 'what would you like to order?' only once.
...
menu={
    "Pizza":{
		"pepperoni pizza" :[ 12.95, 10.00, 7.00] ,"cheese pizza" :  [10.95, 9.25, 6.50] ,"eggplant pizza"  : [11.95, 9.75, 6.75]
            },
	"Extras":{
